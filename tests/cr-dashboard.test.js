...
test('CRDashboard: admin capability — both reviewer and owner sections visible', async () => {
  ...
  el.capabilities = { isReviewer: true, ownedCaseTypes: ["hello-review"], isResponsibleParty: false, isReviewerManager: false, isResponsiblePartyManager: false, isMaintainer: false, isVisitor: false };
  el.eligibleCaseTypes = ['hello-review'];
...
test('CRDashboard: reviewer + RP capability — both reviewer and RP sections visible', async () => {
  ...
  el.capabilities = { isReviewer: true, ownedCaseTypes: [], isResponsibleParty: true, isReviewerManager: false, isResponsiblePartyManager: false, isMaintainer: false, isVisitor: false };
  el.eligibleCaseTypes = ['hello-review'];
