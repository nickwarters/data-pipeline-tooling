...
src/
  ...
  setup/                        # app startup helpers
    ...
    register-routes.js            # the route ENGINE: routeTable() binds each APP_CONFIG.pagePlugins
                                  #   entry to the boot context (a guard becomes a no-arg closure, a
                                  #   loadOverride resolves the host's substitute loader) and
                                  #   registerRoutes() registers it, catching per entry. Names no page
