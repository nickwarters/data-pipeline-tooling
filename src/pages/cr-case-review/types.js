// @ts-check
// Shared typedefs for the Case Review panel bindings. These describe the plain
// context object the `bind*`/`update*` panel functions receive — no runtime
// code, no controller classes.
