...
export function AmendOutcomeSection(props) {
  ...
  if (props.access === 'edit') {
    ...
    children.push(
      h(
        'p',
        { className: 'cr-amend-outcome-empty' },
...
function renderCurrentOutcome(props) {
  ...
  return h(
    'p',
    { className: 'cr-amend-outcome-current' },
...
export function renderAmendmentRecord(amendment) {
  return h(
    'section',
    { className: 'cr-amend-outcome-record' },
    h(
      'p',
      { className: 'cr-amend-outcome-record-justification' },
      amendment.justification
    ),
    h(
      'p',
      { className: 'cr-amend-outcome-record-audit' },
...
export function renderAmendForm(props) {
  ...
  const error = h(
    'p',
    { className: 'cr-amend-outcome-error', hidden: true },
  ...
  return h(
    ...
    h(
      'button',
      {
        className: 'cr-amend-outcome-submit',
...
export class CRAmendOutcome extends ShellElement {
  constructor() {
    super();
    /** @type {CaseRow | null} */
    this.caseRow = null;
...
customElements.define('cr-amend-outcome', CRAmendOutcome);
