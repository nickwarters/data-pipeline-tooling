...
import { activeSlug, baseline, cases, drawerOpen, isDirty, setFilters, showToast } from '../question-bank/question-bank-store.js';
...
export class CRCaseTabs extends ReactiveElement {
  ...
  render() {
    ...
    return h('nav', { className: 'case-bar' },
      h('span', { className: 'case-bar-label' }, 'Case Type'),
      tabs,
      h('div', { className: 'case-bar-right' },
        h('button', { className: 'pill-btn', onclick: () => {
        ...
        h('button', { className: 'pill-btn primary', onclick: () => drawerOpen.set(true),
