 ...
 * it. Left behind on an Answer that has stopped failing, each would be read as
 * current the moment the Answer failed again — a re-failed Answer would render
 * pre-captured and pre-resolved, and the completion gate would count a decision
