...
- **Open, ticketed:** the **Remediation** tab's purpose (#144) and the move of the override to **Case level** via the **Amend Outcome** tab (#145) are parked for dedicated grills and may further touch this model.
