...
| [`shared-readers.md`](shared-readers.md) | Reading data your pipeline does **not** own: the `readers/<subject>.py` Shared Readers that declare a cross-subject read once, how to add one (medallion-backed or not), the guardrails G1–G6, and why a Shared Reader is a pass-through and never a shaping layer. |
