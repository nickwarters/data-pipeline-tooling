...
| [`data-dictionary-reviewer-activity.md`](data-dictionary-reviewer-activity.md) | The gold-only `reviewer_activity_daily` aggregate: sparse Reviewer × local reportable date × Case Type counts reduced from Sync's `case_current`. |
