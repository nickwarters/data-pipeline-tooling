...
Alternatively, use `[data-cora-root]:has(cora-bank-editor)` — works in Edge Chromium per ADR-0001's browser baseline — and avoid touching `app.js`. Pick this if you prefer a pure-CSS fix; it's the smaller change.
