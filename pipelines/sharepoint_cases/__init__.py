...
history to the current Case, its Detail Tables and three aggregates, rebuilt
whole on every poll, and the polling watermark is committed only once every
gold table has landed.
"""
